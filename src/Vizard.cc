   ...
   //}
	...
	if (l.isTilted() && l.isTiltedAuto()) {
	  ...
	  for (int i=0; i < l.tiltedRingsGeometry().size(); i++) {
	    ...
	    tiltedLayerTable->setContent(1, i+1, l.tiltedRingsGeometry()[ringNumber]->tiltAngle(), anglePrecision);
	    tiltedLayerTable->setContent(2, 0, "theta_g (°)");
	    tiltedLayerTable->setContent(2, i+1, l.tiltedRingsGeometry()[ringNumber]->theta_g(), anglePrecision);
	    tiltedLayerTable->setContent(3, 0, "r" + subStart + "Inner" + subEnd);
	    tiltedLayerTable->setContent(3, i+1, l.tiltedRingsGeometry()[ringNumber]->innerRadius(), coordPrecision);
	    tiltedLayerTable->setContent(4, 0, "z" + subStart + "Inner" + subEnd);
	    tiltedLayerTable->setContent(4, i+1, l.tiltedRingsGeometry()[ringNumber]->zInner(), coordPrecision);
	    tiltedLayerTable->setContent(5, 0, "r" + subStart + "Outer" + subEnd);
	    tiltedLayerTable->setContent(5, i+1, l.tiltedRingsGeometry()[ringNumber]->outerRadius(), coordPrecision);
	    tiltedLayerTable->setContent(6, 0, "z" + subStart + "Outer" + subEnd);
	    tiltedLayerTable->setContent(6, i+1, l.tiltedRingsGeometry()[ringNumber]->zOuter(), coordPrecision);
	    tiltedLayerTable->setContent(7, 0, "tiltAngleIdeal" + subStart + "Inner" + subEnd + " (°)");
	    tiltedLayerTable->setContent(7, i+1, l.tiltedRingsGeometry()[ringNumber]->tiltAngleIdealInner(), anglePrecision);
	    tiltedLayerTable->setContent(8, 0, "deltaTiltIdeal" + subStart + "Inner" + subEnd + " (°)");
	    tiltedLayerTable->setContent(8, i+1, l.tiltedRingsGeometry()[ringNumber]->deltaTiltIdealInner(), anglePrecision);
	    tiltedLayerTable->setContent(9, 0, "tiltAngleIdeal" + subStart + "Outer" + subEnd + " (°)");
	    tiltedLayerTable->setContent(9, i+1, l.tiltedRingsGeometry()[ringNumber]->tiltAngleIdealOuter(), anglePrecision);
	    tiltedLayerTable->setContent(10, 0, "deltaTiltIdeal" + subStart + "Outer" + subEnd + " (°)");
	    tiltedLayerTable->setContent(10, i+1, l.tiltedRingsGeometry()[ringNumber]->deltaTiltIdealOuter(), anglePrecision);
	    ...
	    //if (i > 0) {
	    tiltedLayerTable->setContent(15, 0, "deltaZ" + subStart + "Inner" + subEnd + "");
	    tiltedLayerTable->setContent(15, i+1, l.tiltedRingsGeometryInfo().deltaZInner()[ringNumber], coordPrecision);
	    tiltedLayerTable->setContent(16, 0, "deltaZ" + subStart + "Outer" + subEnd + "");
	    tiltedLayerTable->setContent(16, i+1, l.tiltedRingsGeometryInfo().deltaZOuter()[ringNumber], coordPrecision);
	    ...
	    tiltedLayerTable->setContent(17, 0, "zError" + subStart + "Inner" + subEnd);
	    tiltedLayerTable->setContent(17, i+1, l.tiltedRingsGeometryInfo().zErrorInner()[ringNumber], coordPrecision);
	    tiltedLayerTable->setContent(18, 0, "zError" + subStart + "Outer" + subEnd);
	    tiltedLayerTable->setContent(18, i+1, l.tiltedRingsGeometryInfo().zErrorOuter()[ringNumber], coordPrecision);
	    //}
	  }
